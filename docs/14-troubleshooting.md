# Chapitre 14 — Troubleshooting

## Objectif
Guide de résolution des erreurs courantes : OIDC (Not authorized to perform sts), Terraform (AccessDenied, state locked), ECR (no basic auth), ECS (task stopped, CannotPullContainer), RDS (connection timeout), ALB (target unhealthy), CloudFront (403), S3 (AccessDenied).
...
[← Précédent](13-monitoring.md) | [Suivant →](15-destroy.md)
