# Chapitre 10 — GitHub Actions

## Objectif
4 workflows CI/CD : security.yml (scans), terraform.yml (infrastructure), backend-ci-cd.yml (API), frontend-ci-cd.yml (SPA). Déploiement automatique uniquement sur main après passage des contrôles de sécurité.
...
[← Précédent](09-github-oidc.md) | [Suivant →](11-security.md)
